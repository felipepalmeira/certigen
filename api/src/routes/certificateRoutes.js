...
// Define uma rota POST para '/api/v1/certificado' e vincula essa rota ao método 'createCertificate' do certificateController.
// Quando uma requisição POST é feita para essa rota, o Express chama a função 'createCertificate' para processá-la.
router.post('/api/v1/certificado', certificateController.createCertificate);
